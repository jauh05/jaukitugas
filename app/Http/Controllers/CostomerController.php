...

{
    ...
    function store(Request $request): RedirectResponse{
      ...
      $masuk['total'] = $request->total;
      $masuk['selesaikan'] = $request->selesaikan;
      $masuk['id_metode'] = $request->metode;

      Costomer::create($masuk);
      return redirect('dashboard/costomer')->with('pesan_berhasil','berhasil ditambahkan');;
    }
    ...
    function update(Request $request, $id_costomer){
      ...
      Costomer::find($id_costomer)->update($masuk);
      return redirect('dashboard/costomer')->with('pesan_berhasil','status pesanan berhasil diganti');
